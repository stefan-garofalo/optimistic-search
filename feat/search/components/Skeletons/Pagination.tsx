...
export default function SkeletonPagination() {
	return (
		<div className="shrink-0 h-full flex items-center gap-x-3">
			<div className="h-full flex flex-col justify-center gap-y-2 w-28">
				<span className="bg-foreground rounded h-1.5 animate-pulse w-1/2"></span>
				<span className="bg-foreground rounded h-1.5 animate-pulse w-full"></span>
			</div>
